...
open class RtkMeetingHeaderView: UIView {
    ...
    private var meetingTitleLabel: RtkMeetingTitleLabel!
    ...
    private func createSubview(containerView: UIView) {
        ...
        meetingTitleLabel = RtkMeetingTitleLabel(meeting: meeting)
        ...
        stackView.addArrangedSubviews(meetingTitleLabel, stackViewSubTitle)
...
public extension RtkMeetingHeaderView {
    ...
    /// Update the meeting title displayed in the header.
    /// Use this instead of accessing `meetingTitleLabel` directly to preserve encapsulation.
    func updateMeetingTitle(_ title: String) {
        meetingTitleLabel.text = title
    }
